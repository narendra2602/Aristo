    ...
    <html:form action="addUserRights.do?actionRequested=addUserRights">
		...
		<input type="hidden" name="tp1" value="<%=tp1%>"/>				
            ...
            <table border="0"  cellpadding="0" cellspacing="0" class="tablereg">
                <th colspan="4">    User Rights HQ      </th>
		      <tr>
                <td colspan="4"><strong>
				<br/>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST01"/></td>
                <td>Selective Stockiest Product Wise Credit Note Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST02"/> </td>
                <td>Selective Stockiest Prod Wise Gross/Credit/Net Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST03"/> </td>
                <td>Stockiest Wise Rs.-Wise Trend Gross/Credit/Net</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST04"/> </td>
                <td>Selective Stockiest Wise Product Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST05"/> </td>
                <td>Selective Stockiest Wise Group Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST06"/> </td>
                <td>Stockiest Rupees Wise Salable/Exp/Brk</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST07"/> </td>
                <td>Selective Stockiest Group Wise Credit Note Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST08"/> </td>
                <td>Selective Stockiest Group Wise Gross/Credit/Net Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST09"/> </td>
                <td>Selective Product Wise Stockiest Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HST10"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI01"/> </td>
                <td>Product Wise Gross/Credit/Net Sales</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI02"/> </td>
                <td>Group Wise Gross/Credit/Net Sales</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI03"/> </td>
                <td>Rupeeswise Salable/Expiry/Breakage</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI04"/> </td>
                <td>Selective HQ/Region/Area/Branch</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI06"/> </td>
                <td>Selective Product - HQ/Region/Area/Branch</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI07"/> </td>
                <td>Selective Group - HQ/Region/Area/Branch</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBI08"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM04"/> </td>
                <td>Selective HQ/Reg/Are/Brn/Prd Wise Detail</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM05"/> </td>
                <td>Product Wise This Year/Last Year</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM06"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM08"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM10"/> </td>
                <td>Product Wise Target/Sale Comparison</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM11"/> </td>
                <td>Rupees Wise Sales Analysis Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM12"/> </td>
                <td>Selective Group - Rupees Wise Sales  Analysis</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HBM13"/> </td>
