...
<body >
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>  
<html:form action="BranchFactoryListRepo3.do?actionRequested=BranchFactoryListRepo3" onsubmit="return validateDate()">
  <center>
  <table cellpadding="0" cellspacing="0" class="table_opt">
	...
	<tr>
      ...
      <td>Pharma/Lab</td>
      <td>
      <html:radio property="pchoice" value="P" onclick="showCustomer(this.value,'BranchFactoryAjxRepo3.do?actionRequested=BranchFactoryAjxRepo3')" /> Pharma &nbsp; &nbsp; &nbsp; &nbsp; 
	  <html:radio property="pchoice" value="L" onclick="showCustomer(this.value,'BranchFactoryAjxRepo3.do?actionRequested=BranchFactoryAjxRepo3')" /> Lab
	  </td>	  
    </tr>
