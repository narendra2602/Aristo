...
<body >
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="BranchFactoryListRepo5.do?actionRequested=BranchFactoryListRepo5" onsubmit="return validateDate()">
  <center>
  <table cellpadding="0" cellspacing="0" class="table_opt">
    ...
    <tr>
      ...
      <td>
   <div id="abc">	  
     <html:select styleId="location" property="loc" style="width:190px"  onchange="showCustomer1(this.value,'BranchFactoryAjxRepo5b.do?actionRequested=BranchFactoryAjxRepo5b'); Select() " >
	...
	<tr>
      ...
      <td>Sale/Samples:</td>
      <td>
      <html:radio property="schoice" styleId="select" value="P"  onclick="showCustomer2(this.value,'BranchFactoryAjxRepo5a.do?actionRequested=BranchFactoryAjxRepo5a'); makeSelect()" /> Sales  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
	  <html:radio property="schoice" value="S"  onclick="showCustomer2(this.value,'BranchFactoryAjxRepo5a.do?actionRequested=BranchFactoryAjxRepo5a'); makeSelect()"  /> Sample
	  </td>	  
    </tr>
