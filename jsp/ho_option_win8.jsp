...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HOListRepo8.do?actionRequested=HOListRepo8">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                   <th colspan="6">HO-Selective Products- Sales Trend (Gross)</th>
                ...
                <tr>
                  <td colspan="5">
					<table class="table3" align="center">
					  <tr>
						<td>
						Select Month <html:select property="emon">
