    ...
    <html:form action="addUserRights.do?actionRequested=addUserRights">
		...
		%>
            ...
            <table border="0"  cellpadding="0" cellspacing="0" class="tablereg">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR01"/></td>
                <td>Inward Invoice</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR02"/> </td>
                <td>Outward Invoice</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR03"/> </td>
                <td>Sales Invoice</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR04"/> </td>
                <td>Nepal Invoice</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR05"/> </td>
                <td>Order Entry</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR06"/> </td>
                <td>Delivery Challan</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TR07"/> </td>
                <td>Packing List</td>
                <td>&nbsp;</td>
              </tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN01"/> </td>
                <td>Stock & Sales</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN02"/> </td>
                <td>Near Expiry List</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN03"/> </td>
                <td>Non-Moving Items</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN04"/> </td>
                <td>Product/Batch Wise Stock</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN05"/> </td>
                <td>Stock Ledger</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN06"/> </td>
                <td>Location Wise Reciept</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN07"/> </td>
                <td>Inward Register</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN08"/> </td>
                <td>Inward Register Branch Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN09"/> </td>
                <td>Date Wise Stock Value</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IN10"/> </td>
