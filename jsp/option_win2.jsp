...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               <html:form action="ListRepo4.do?actionRequested=ListRepo4">
                <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                  <th colspan="6">Selective HQ/Region/Area/Branch</th>

                 <tr>
                  <td colspan="5">
					<table class="table3" align="center">
                      <tr>
<td><html:radio property="rep_type" value="1" onclick="showCustomer(this.value,'OptRepo4.do?actionRequested=OptRepo4')"/>H.Q.</td>
<td><html:radio property="rep_type" value="2" onclick="showCustomer(this.value,'OptRepo4.do?actionRequested=OptRepo4')"/>Region</td>
<td><html:radio property="rep_type" value="3" onclick="showCustomer(this.value,'OptRepo4.do?actionRequested=OptRepo4')"/>Area</td>
<td><html:radio property="rep_type" value="4" onclick="showCustomer(this.value,'OptRepo4.do?actionRequested=OptRepo4')"/>Branch</td>
                      </tr>
                    </table>				 </td>
                </tr>
					...
					<table class="table3" align="center">
   					   <tr>
		 					...
		 					<div id="results">
								   ...
								   <html:optionsCollection name="Repo2Form"
