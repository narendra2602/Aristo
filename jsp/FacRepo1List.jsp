...
<div class="div1">	 
 ...
 <display:table id="data" name="requestScope.FacRepo1Form.rlist" requestURI="./BranchFactoryListRepo1.do?actionRequested=BranchFactoryListRepo1" pagesize="20" export="true" decorator="org.displaytag.decorator.TotalTableDecorator">
