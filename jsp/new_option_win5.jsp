...
<body id="target">
  ...
  <html:form action="NWListRepo5.do?actionRequested=NWListRepo5">
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<table border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
				  <th colspan="5">Rupeewise Gross/Credit/Net Sale</th>
                  
                  <tr>
                    <td style="padding-left: 85px;"><html:radio property="r_type"  value="1"  onclick="disableCombo();"/>All &nbsp; </td>
                    <td ><html:radio property="r_type"  value="2" styleId="brCheck" onclick="enableCombo();"/>Groupwise</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
 	             ...
 	             <tr>
					...
					<td>
						<div id="results">
					    Group 
							<html:select property="grp_code" value="0" disabled="true" styleId="grpSelect" style="width:180px">
							  <html:optionsCollection name="HORepo5Form" property="alist" label="nm2" value="qty2" />
							</html:select>
						</div>
					</td>
				...
				<html:select property="eyear">
		                <html:optionsCollection name="HORepo5Form" property="ylist" label="yname" value="yval" />
        		</html:select>	
