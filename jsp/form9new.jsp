...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br/>
<div id="main">		
 <display:table id="data"  class="simple nocol" name="requestScope.rlist" requestURI="./NWListForm9.do?actionRequested=NWListForm9" pagesize="25"  export="true" >
       ...
       <display:caption media="html"> <div style="font-size:18px" align="left"><strong><br/><%=whead%></strong></div> </display:caption>
		...
		<display:column property="val2" title="GROSS" format="{0,number,0.00}" headerClass="r" class="r"/> 
		<display:column property="val3" title="EXPIRY" format="{0,number,0.00}" headerClass="r" class="r"/> 
		<display:column property="val4" title="EXPIRY RATIO" format="{0,number,0.00}" headerClass="r" class="r" />
	</display:table>
</div>	
<br>
<br> 
