...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br/>
  <display:table id="data" class="simple nocol" name="requestScope.rlist" requestURI="./NWListForm7.do?actionRequested=NWListForm7" pagesize="25" export="true" decorator="dyndecorator">
        ...
        <display:caption media="excel">BRANCH NAME: <%=ak%>, <%=whead%>,  LAST UPDATE: <%=lupdate%></display:caption>
            ...
            <display:column property="no_of_mr" title="FS"  /> 
