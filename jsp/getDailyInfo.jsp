         ...
         <table style="border-collapse: collapse; border-width: 0px;">
            <tr>
               ...
               <td>
                  ...
                  <html:text property="bud_per" tabindex="1" size="5" />
                  <html:text property="sales_bud" tabindex="2" size="9" />

               </td>

               <td>1. Collection Today</td>
               <td>
                  <html:text property="collc" tabindex="8" />
               </td>
            </tr>
            <tr>
               <td>2. CN 100%</td>
               <td>
                  <html:text property="cn100" tabindex="3" />
               </td>
               <td>2. Collection Cumm.</td>
               <td>
                  <html:text property="collcumm" tabindex="9" />
               </td>
            </tr>
            ...
            <tr>
               ...
               <td>
                  <html:text property="sale_today" tabindex="4"  />
               </td>
               <td>3. Remittance Today</td>
               <td>
                  <html:text property="remit" tabindex="10" />
               </td>
            </tr>
            <tr>
               <td>4. Net Sales Upto Date</td>
               <td>
                  <html:text property="trd_sale" tabindex="5" />
               </td>
               <td>4. Remittance Cumm.</td>
               <td>
                  <html:text property="remitcumm" tabindex="11" />
               </td>
            </tr>
            <tr>
               <td>5 Last Month Sales </td>
               <td>
                  <html:text property="lmsale" tabindex="6" />
               </td>
               <td>5. Outstanding as on Date</td>
               <td>
                  <html:text property="outstnd" tabindex="12" />
               </td>
            </tr>
            <tr>
               <td>6. Last Year Sales </td>
               <td>
                  <html:text property="lysale" tabindex="7" />
               </td>
               <td>6. Monthly Billing Status</td>
               <td>
                  <html:select property="status" tabindex="13">
