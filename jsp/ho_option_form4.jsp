...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <html:form action="HOListForm4.do?actionRequested=HOListForm4">
                 <p>&nbsp;</p>
                 <table border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
                     <th colspan="3">HO-Selective Products- Sales/Taget Trend</th>
                  ...
                  <tr>
		                <td>
						   <table border="0" align="center" cellpadding="0" cellspacing="0" class="table3">
                             ...
                             <tr>
                               <td><div align="left">
                                   <html:radio property="st"  value="1"/>
                               Sales</div></td>
                               <td><div align="left">
                                 <html:radio property="st"  value="2"/>
                               Target</div></td>
                             ...
                             <tr>
                               <td colspan="3"><div align="left">
                                   <html:radio property="all"  value="1"/>
                               All India Productwise Net Sale Trend</div></td>
                             </tr>
					...
					<table class="table3" align="center">
   					   <tr>
							 ...
							 <td align="center">Select <%=d%> <br/>
								   ...
								   <html:optionsCollection name="HOForm4Form"
									property="xlist" label="pname" value="pcode" />  
								   </html:select>					     </td> 
							   ...
							   <td>Selected <%=d%>
								  <br/>
									  ...
									  <html:optionsCollection name="HOForm4Form"
									  property="rlist" label="pname" value="pcode" />  
									  </html:select>							   </td>
					   </tr>
				    </table>				  </td>
				</tr> 
                ...
                <tr>
                  <td>
                    ...
                    <html:select property="eyear">
                          <html:optionsCollection name="HOForm4Form" property="ylist" label="yname" value="yval" />
                    </html:select>						
