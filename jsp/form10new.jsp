...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br/>
  <display:table id="data" class="simple nocol" name="requestScope.rlist" requestURI="./NWListForm10.do?actionRequested=NWListForm10" pagesize="25" export="true" decorator="dyndecorator">
