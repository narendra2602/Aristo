...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HOListRepo7.do?actionRequested=HOListRepo7">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                   <th colspan="6">Selective Group Branch Wise </th>
                  ...
                  <table border="0" align="center" cellpadding="0" cellspacing="0" class="table3">
                    ...
                    <tr>
                      ...
                      <td width="71">
                        ...
                        <div align="left">
                          <html:radio property="r_type"  value="1"/>
                        Actual</div></td>
                      <td width="84">
                  ...
                  <table border="0" align="center" cellpadding="0" cellspacing="0" class="table3">
                    ...
                    <tr>
                      ...
                      <td width="71">
                        ...
                        <div align="left">
                          <html:radio property="repoptn"  value="1"/>
                        Cummulative</div></td>
                      <td width="84">
                          
                        <div align="left">
                          <html:radio property="repoptn"  value="2"/>
                        Trend</div></td>
                    </tr>
                                  </table>
                </div></td>
              ...
              <tr>
				...
				<html:select property="eyear" onchange="showCustomer(this.value,'HOAjaxRepo7.do?actionRequested=HOAjaxRepo7')">
		                <html:optionsCollection name="HORepo7Form" property="ylist" label="yname" value="yval" />
        		</html:select>	
   					   ...
   					   <tr>
							 ...
							 <td align="center">Select <%=d%> <br/>
							     <div id="abc">
								   ...
								   <html:optionsCollection name="HORepo7Form" property="xlist" label="gname" value="gcode" />  
								   </html:select>	
 							     </div>
            				  </td> 
							   ...
							   <td>Selected <%=d%>
								  <br/>
									  ...
									  <html:optionsCollection name="HORepo7Form"
									  property="rlist" label="gname" value="gcode" />  
									  </html:select>							   </td>
					   </tr>
				    </table>				  </td>
				</tr> 
