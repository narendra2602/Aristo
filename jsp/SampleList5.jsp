...
%> 
   ...
   <p>&nbsp;</p>
   <div class="div1">	 
 <display:table id="data" name="requestScope.SampleRepo2Form.rlist" requestURI="./SampleListRepo5.do?actionRequested=SampleListRepo5" pagesize="20" export="true" decorator="dyndecorator" >
