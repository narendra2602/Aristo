...
<body id="target">
  ...
  <html:form action="NWListForm11.do?actionRequested=NWListForm11">
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<table border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
				  <th colspan="5">Branch/HQ Rupeewise Performance</th>
                  
                  <tr>
                    <td style="padding-left: 85px;"><html:radio property="sale_type"  value="1" styleId="brCheck" onclick="enableCombo();"/>Groupwise</td>
                    <td><html:radio property="sale_type"  value="2" onclick="disableCombo();"/>All &nbsp; </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
