...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HOListInv3.do?actionRequested=HOListInv3">
                 <p>&nbsp;</p>
				 <p>&nbsp;</p>
				 <p>&nbsp;</p>
				 <p><br/><br/>
				 ...
				 <table align="center" cellpadding="0" cellspacing="0" class="usertable">
                     <th colspan="5">Sales Analysis </th>
                ...
                <tr>
                  <td colspan="5">
                    ...
                    <html:select property="eyear">
                          <html:optionsCollection name="Inv3Form" property="ylist" label="yname" value="yval" />
                    </html:select>   
