...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br/>
	<div id="main">	
      <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./ListRepo13.do?actionRequested=ListRepo13" pagesize="25"  export="true" decorator="totals">
