...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br/>
	<div id="main">	
      <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./ListRepo12.do?actionRequested=ListRepo12" pagesize="25"  export="true" decorator="totals">
