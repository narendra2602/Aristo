...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HOListRepo12.do?actionRequested=HOListRepo12">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                       <th colspan="6">Selective Product HQ Wise Rupee Wise Trend </th>

              <tr>
                <td colspan="5"><table border="0" align="center" cellpadding="0" cellspacing="0" class="table3">
                  <tr>
                    <td>
              ...
              <% String d = (String) request.getAttribute("data"); %>
					...
					<table class="table3" align="center">
   					   <tr>
							 ...
							 <td align="center">Select <%=d%> <br/>
								   ...
								   <html:optionsCollection name="HORepo8Form"
				...
				<html:select property="eyear">
		                <html:optionsCollection name="HORepo8Form" property="ylist" label="yname" value="yval" />
        		</html:select>	
