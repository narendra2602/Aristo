...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br>   
              ...
              %> 
               ...
               <br/>    
 <display:table id="data"  class="simple nocol" name="requestScope.rlist" requestURI="./NWListRepo5.do?actionRequested=NWListRepo5" pagesize="25"  export="true">
            ...
            <display:column property="pi" title="PI SALE" format="{0,number,0.00}" headerClass="r" class="r" />
