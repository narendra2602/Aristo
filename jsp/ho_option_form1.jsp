...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HOListForm1.do?actionRequested=HOListForm1">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                   <th colspan="6">HO-Selective Product - Rupeewise Target/Sale/Ach/Gr/Pmr</th>

              
              <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><html:radio property="opt"  value="1"/>H.Q. Wise</td>
                <td><html:radio property="opt"  value="2"/>Branch Wise</td>
                <td>&nbsp;</td>
              </tr>
					...
					<table class="table3" align="center">
   					   <tr>
							 ...
							 <td align="center">Select <%=d%> <br/>
								   ...
								   <html:optionsCollection name="HOForm1Form"
                ...
                <tr>
                  <td colspan="5">
                    ...
                    <html:select property="eyear">
                          <html:optionsCollection name="HOForm1Form" property="ylist" label="yname" value="yval" />
                    </html:select>   
