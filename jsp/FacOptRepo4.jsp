...
<html:form action="BranchFactoryListRepo4.do?actionRequested=BranchFactoryListRepo4" onsubmit="return validateDate()">
  <center>
  <table cellpadding="0" cellspacing="0" class="table_opt">
	...
	<tr>
      ...
      <td>Pharma/Lab</td>
      <td>
      <html:radio property="pchoice" value="P" onclick="showCustomer(this.value,'BranchFactoryAjxRepo4.do?actionRequested=BranchFactoryAjxRepo4')" /> Pharma &nbsp; &nbsp; &nbsp; &nbsp; 
	  <html:radio property="pchoice" value="L" onclick="showCustomer(this.value,'BranchFactoryAjxRepo4.do?actionRequested=BranchFactoryAjxRepo4')" /> Lab
	  </td>	  
    </tr>
