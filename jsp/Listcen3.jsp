...
<%@ page import="com.aristo.valueobject.Cen3FormBean" %>  
...
<body>
	...
	request.setAttribute("dyndecorator", new org.displaytag.decorator.TableDecorator()
	{
		...
		{
		  int data = ((Cen3FormBean)getCurrentRowObject()).getColour();
		  if (data==2)
			 return "money";
		  else
			if (data==3)
   ...
   <p>&nbsp;  </p>
	 <div class="div1">	 
 <display:table id="data" name="requestScope.Cen3Form.rlist" requestURI="./ListCen3.do?actionRequested=ListCen3" pagesize="20" export="true" decorator="dyndecorator" >
