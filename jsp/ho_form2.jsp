...
%>
  ...
  <br />
  <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list"
    requestURI="./HOListForm2.do?actionRequested=HOListForm2" pagesize="25" export="true" decorator="dyndecorator">
