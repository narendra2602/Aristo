...
%>
    ...
    <br/>
	<div id="main">	
      <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./ListRepo7.do?actionRequested=ListRepo7" pagesize="25"  export="true" decorator="totals">
