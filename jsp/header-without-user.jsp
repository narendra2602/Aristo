    ...
    <div class="home-page-square-3"></div> 
		<section class="top-section">
			...
			<section class="top-section-right-cover">
					<div class="top-section-right"><a href="/Aristo/LogoutUserForward.do?actionRequested=LogoutUserForward"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"  title="Sign out" class="User-img" /></a></div>
			</section>
		</section>
