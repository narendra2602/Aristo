...
%>
    ...
    <br/>
      <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./HOListRepo6.do?actionRequested=HOListRepo6" pagesize="25"  export="true" >
            ...
            <display:column property="fqty" title="FREE QTY" format="{0,number,0}" headerClass="r" class="r"/> 
            <display:column property="fval" title="VALUE" format="{0,number,0.00}" headerClass="r" class="r"/> 
