...
<html:form action="BranchFactoryListRepo1.do?actionRequested=BranchFactoryListRepo1" onsubmit="return validateDate()">
  <center>
  <table cellpadding="0" cellspacing="0" class="table_opt">
    <tr>
      <th colspan="4">Dispatch Register</th>
    </tr>
	...
	<tr>
      ...
      <td>Pharma/Lab</td>
      <td>
      <html:radio property="pchoice" value="P" onclick="showCustomer(this.value,'BranchFactoryAjxRepo1.do?actionRequested=BranchFactoryAjxRepo1')" /> Pharma &nbsp; &nbsp; &nbsp; &nbsp; 
	  <html:radio property="pchoice" value="L" onclick="showCustomer(this.value,'BranchFactoryAjxRepo1.do?actionRequested=BranchFactoryAjxRepo1')" /> Lab
	  </td>	  
    </tr>
