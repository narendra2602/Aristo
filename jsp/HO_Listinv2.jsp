...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <jsp:scriptlet>
        request.setAttribute("dyndecorator", new org.displaytag.decorator.TableDecorator()
        {
            ...
            {
              int data = ((Inv2FormBean)getCurrentRowObject()).getCode();
			  if (data==0)
			     return "bad";
			  else
			    if (data==1)
     ...
     <br/>
   <display:table id="data" class="simple nocol" name="requestScope.rlist" requestURI="./HOListInv2.do?actionRequested=HOListInv2" pagesize="25" export="true" decorator="dyndecorator">
