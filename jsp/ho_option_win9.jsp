...
<html:form action="HOListRepo9.do?actionRequested=HOListRepo9">
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table border="0" align="center" cellpadding="0" cellspacing="0" class="usertable">
                <th colspan="4">HO-Branch Wise -Rupees Wise Sales Trend</th>
              <tr>
                <td width="32">&nbsp;</td>
              ...
              <tr>
				...
				Select Month <html:select property="emon">
		                ...
		                <html:optionsCollection name="HORepo9Form" property="ylist" label="yname" value="yval" />
        		          </html:select>	
