...
<div class="ddcolortabsline">&nbsp;</div>
	...
	<a href="/Aristo/PmtRightsList.do?actionRequested=PmtRightsList">PMT User Rights</a>		
	...
	<table width="100%" align="right" cellpadding="0" cellspacing="0" class="datetable">
      <tr>
        ...
        <th width="19%"><strong><img src="images/users.png" width="14" height="17">&nbsp; <%=x%></strong></th>
        <th width="23%"><script>
...
setInterval("getthedate()",1000)
        ...
        <th width="9%" align="center" valign="bottom" scope="col"> <img src="images/logout.png" width="17" height="17"> <a href="/Aristo/LogoutUserForward.do?actionRequested=LogoutUserForward">Logout</a></th>
      </tr>
    </table>
</body>
