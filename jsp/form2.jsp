...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <jsp:scriptlet>
    ...
    <br/>
<div id="main">	
   <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./ListForm1.do?actionRequested=ListForm1" pagesize="25" export="true" decorator="dyndecorator">
        ...
        <display:caption media=" excel rtf pdf">BRANCH NAME: <%=ak%>, <%=whead%>,  LAST UPDATE: <%=lupdate%></display:caption>
            ...
            <display:column property="dval4" title="MTH ACH%" format="{0,number,0.00}" headerClass="r" class="r"/> 
