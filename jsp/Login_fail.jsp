        ...
        <div class="container">
            <div class="animsition">
                <div class="join-main-section">
                    ...
                    <html:form styleId="auto_off" action="authenticateUser.do?actionRequested=authenticateUser"
                        styleClass="join-form" style="background-color: brown;">

                        <div class="login-label" style="margin-bottom:20px;">
                            <label><u>LOGIN</u></label>
                        </div>
                        <div class="input-group" style="text-align: center;"><label>Invalid Username/Password</label>
                        </div>
