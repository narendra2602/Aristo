...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <br/>
<div id="main">	    
  <display:table id="data" name="requestScope.rlist" requestURI="./ListForm9.do?actionRequested=ListForm9" pagesize="25" export="true" >
        ...
        <display:caption media=" excel rtf pdf">BRANCH NAME: <%=ak%>, <%=whead%>,  LAST UPDATE: <%=lupdate%></display:caption>
            ...
            <display:column property="pack" title="PACK" />
             ...
             <%
              ...
              {
             %>	     
            <display:column property='<%="qty0["+j+"]"%>' title="<%=a[j]%>" headerClass="r" class="r" format="{0,number,0}"/>
