...
<%@ page import="com.aristo.valueobject.SampleRepo7FormBean" %>  
...
<body>
 ...
 <p>&nbsp;  </p>
 <div class="div1">	 
 <display:table id="data" name="requestScope.SampleRepo7Form.rlist" requestURI="./SampleListRepo7.do?actionRequested=SampleListRepo7" pagesize="20" export="true" >
			...
			<display:column property="inv_type" title="ISSUE SEQUENCE" headerClass="r" class="r" /> 
