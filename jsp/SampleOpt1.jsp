...
%>
  ...
  <body>
    ...
    <html:form action="SampleListRepo1.do?actionRequested=SampleListRepo1" >
      <center>
        <table align="center" cellpadding="0" cellspacing="0" class="usertable">
          <tr>
            <th colspan="2">Sample Stock Statement/FS Issue Trend</th>
          </tr>

          <tr>
            <td colspan="2">
              <div align="center">
                <html:radio property="choice" value="1"  />Stock Statement
                &nbsp;
                <html:radio property="choice" value="2"  />FS Issue Trend
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style="text-align: left;">
              ...
              <html:select property="dcode" styleId="mydiv" >
            ...
            <td style="text-align: left;">
              <div id="results">
                <html:select property="code" styleId="mySelect">
                  <html:optionsCollection name="SampleRepo2Form" property="branchlist" label="dname" value="dcode" />
                </html:select>
              </div>
            </td>
          </tr>
