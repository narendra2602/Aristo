...
<html:form action="AddBudSal.do?actionRequested=AddBudSal" >
...
<table width="434" border="0" align="center" cellpadding="0" cellspacing="0" class="usertable">
                  <th colspan="6">Sales Budget Entry</th>
                <tr>
                  <td width="36">&nbsp;</td>
                  <td colspan="4">&nbsp;</td>
                </tr>
			...
			<tr>
			      <td>&nbsp;</td>				  
                  <td><div align="left">Sales Budget </div></td>
                  <td><div align="left"><html:text property="sales_bud" /></div></td>
            </tr>
