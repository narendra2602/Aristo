...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="ListRepo8.do?actionRequested=ListRepo8">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                   <th colspan="6">Selective Products- Sales Trend (Gross/Credit/Net)</th>
                ...
                <td colspan="6">
				   <table class="table3" align="center">
						...
						<tr>
					        ...
					        Tot Credit</div></td>
							<td> <div align="left">
						      <html:radio property="sale_type"  value="4"/>
					        Expiry</div></td>
							<td> <div align="left">
						      <html:radio property="sale_type"  value="5"/>
					        Salable</div></td>
							<td> <div align="left">
						      <html:radio property="sale_type"  value="6"/>
					        Brk/Spoiled</div></td>
							<td> <div align="left">
              ...
              <% String d = (String) request.getAttribute("data"); %>
                ...
                <tr>
                  <td colspan="6">
					<table class="table3" align="center">
					  <tr>
						<td> Select Month <html:select property="mnth1">
