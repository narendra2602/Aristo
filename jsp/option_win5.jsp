...
<html:form action="ListRepo5.do?actionRequested=ListRepo5">
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table border="0" align="center" cellpadding="0" cellspacing="0" class="usertable">
              <th colspan="3">Rupeeswise Gross/Credit/Net Sale</th>
              <tr>
                <td><html:radio property="rep_type"  value="1"/>Region</td>
                <td><html:radio property="rep_type"  value="2"/>Area</td>
                <td><html:radio property="rep_type"  value="3"/>Branch</td>
              </tr>
