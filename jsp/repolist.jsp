...
<br/>
    <br>    <display:table id="data" name="sessionScope.Repo1Form.rlist" pagesize="25" export="true"  >
      ...
      <display:caption media=" excel rtf pdf"><%=whead%></display:caption>                       
            ...
            <display:column property="no_of_mr" title="NO-OF-MR" />
            ...
            <display:column property="ytd_sale" title="YTD SALE"/>
            <display:column property="ytd_targt" title="YTD TGT"/>
            <display:column property="ach" title="ACH"/>
            <display:column property="avg_sale" title="AVG SALE"/>
            <display:column property="pmr" title="PMR"/>
