...
<div id="calendarDiv"> </div>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="SampleListRepo9.do?actionRequested=SampleListRepo9" onsubmit="return validateDate()">
  ...
  <table align="center" cellpadding="0" cellspacing="0" class="usertable">
    ...
    <tr>
      <td>Start Date:&nbsp;&nbsp;&nbsp;<html:text property="sdate" styleClass="calendarSelectDate" style="text-align:center" />  </td>
    </tr>
	
    <tr>
      <td>End Date:&nbsp;&nbsp;&nbsp;&nbsp;
      <html:text property="edate" styleClass="calendarSelectDate" style="text-align:center" /> </td>
    </tr>	
