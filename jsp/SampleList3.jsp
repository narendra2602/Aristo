...
%> 
   ...
   <p>&nbsp;  </p>
	 <div class="div1">	 
 <display:table id="data" name="requestScope.SampleRepo3Form.rlist" requestURI="./SampleListRepo3.do?actionRequested=SampleListRepo3" pagesize="20" export="true" >
            ...
            <display:column property="estock360" title="EXPIRY Above 180 DAYS"   headerClass="r" class="r" /> 
