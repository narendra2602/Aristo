...
<body id="target">
  ...
  <html:form action="NWListForm8.do?actionRequested=NWListForm8">
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<table border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
				  <th colspan="5">Brn/HQ Wise Saleable/Expiry/Breakage</th>
                  

 	             <tr>
					<td colspan="4" style="padding-left: 90px;">Branch &nbsp;&nbsp;
						<html:select property="code" styleId="mySelect" >
						  <html:optionsCollection name="Repo2Form" property="blist" label="dname" value="dcode" />
						</html:select>
                    </td>
