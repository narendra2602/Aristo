...
<html:form action="HOListRepo5.do?actionRequested=HOListRepo5">
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table border="0" align="center" cellpadding="0" cellspacing="0" class="usertable">
                <th>HO-Rupeeswise Gross/Credit/Net Sale</th>
              
              

			  <tr>
			  <td><html:radio property="r_type"  value="1"/> Actual  &nbsp; &nbsp;  &nbsp; &nbsp;
                  <html:radio property="r_type"  value="2"/> In Lacs </td>
			  </tr>
              <tr>
                <td>
					From
