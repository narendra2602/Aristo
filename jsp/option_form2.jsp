...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="ListForm2.do?actionRequested=ListForm2">
                 <p>&nbsp;</p>
				 <br/>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                 <th colspan="6">Selective Group - Rupeewise Target/Sale/Ach/Gr/Pmr</th>
                  ...
                  <td colspan="5">
					<table class="table3" align="center">
					  <tr>
						...
						Select Month <html:select property="mnth1">
                        ...
                        <html:option value="12">Sep</html:option>
						     ...
						     Mkt Year 
                         <html:select property="eyear" onchange="showCustomer(this.value,'AjaxForm2.do?actionRequested=AjaxForm2')">
