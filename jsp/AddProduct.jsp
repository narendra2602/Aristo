...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" >
              ...
              <html:form action="AddProduct.do?actionRequested=AddProduct" >
                <p>&nbsp;</p>			<p>&nbsp;</p>				
                <table width="33%" border="0" align="center" cellpadding="0" cellspacing="0" class="usertable1">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>Product Code </td>
                    <td><html:text property="pcode" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td>Product Group </td>
					<td>					
				<html:select property="pd_group">
		                <html:optionsCollection name="ProductForm" property="glist" label="gname" value="gcode" />
        		</html:select>		
                  ...
                  <tr>
                    ...
                    <td>Group Code</td>
                    <td>
				<html:select property="mgrp">
		                <html:optionsCollection name="ProductForm" property="gplist" label="gpname" value="gpcode" />
        		</html:select>		
					</td>
                    <td>&nbsp;</td>
                  </tr>
