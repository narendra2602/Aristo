...
<%     
      ...
      String head3=null;
            ...
            HOForm2FormBean rf = new HOForm2FormBean();  
        	List l = (List) request.getAttribute("rlist") ;  
            Iterator it =  l.iterator();
            	if(it.hasNext())
             	{
             	 rf=(HOForm2FormBean)it.next();    
             	  whead=rf.getHead1();
				  per = rf.getPer();
...
%>
    ...
    <jsp:scriptlet>
        request.setAttribute("dyndecorator", new org.displaytag.decorator.TableDecorator()
        {
            ...
            {
              int data = ((HOForm2FormBean)getCurrentRowObject()).getPcode();
			  if (data==2)
			     return "bad";
			  else
			    if (data==3)
    ...
    <br/>
      <display:table id="data" class="simple nocol" name="requestScope.rlist" requestURI="./HOListForm6.do?actionRequested=HOListForm6" pagesize="25"  export="true" decorator="dyndecorator">
