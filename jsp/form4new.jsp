...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br/>
<div id="main">	
      <display:table id="data" class="simple nocol" name="requestScope.rlist" requestURI="./NWListForm4.do?actionRequested=NWListForm4" pagesize="25"  export="true" decorator="dyndecorator">
