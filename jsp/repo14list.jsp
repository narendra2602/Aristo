...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <jsp:scriptlet>
    ...
    <br/>
<div id="main">	
 <display:table id="data"  class="simple nocol" name="requestScope.rlist" requestURI="./ListRepo14.do?actionRequested=ListRepo14" pagesize="25"  export="true" decorator="dyndecorator" >
   ...
   <display:caption media=" excel rtf pdf">BRANCH NAME: <%=x%>, <%=whead%>,  LAST UPDATE: <%=lupdate%></display:caption>
            ...
            <display:column property="grossval" title="GROSS SALE" format="{0,number,0.00}" headerClass="r" class="r"/> 
            ...
            <display:column property="brkval" title="BRK/SPL/PD" format="{0,number,0.00}" headerClass="r" class="r" />
