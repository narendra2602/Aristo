...
<html:form action="SampleListRepo5.do?actionRequested=SampleListRepo5" onsubmit="return validateDate()">
  <center>
    <table align="center" cellpadding="0" cellspacing="0" class="usertable">
      <tr>
        <th colspan="2">Partywise Sample Statement</th>
      </tr>
        ...
        <tr>
          ...
          <td style="padding-left: 125px; text-align: left;" >Selection:</td><td style="text-align: left;">
        ...
        <tr>
          ...
          <td style="padding-left: 125px;text-align: left;">Product</td><td style="text-align: left;">
            <html:select property="pcode" styleId="mySelect">
              <html:optionsCollection name="SampleRepo5Form" property="plist" label="pname" value="pval" />   
          </html:select>
      </td>
        </tr>
        <tr>
        
        <td style="padding-left: 125px;text-align: left;">Start Date:</td><td style="text-align: left;">
          <html:text property="sdate" styleClass="calendarSelectDate" style="text-align:center" />  
        </div></td>
      </tr>
      <tr>
      
        <td style="padding-left: 125px;text-align: left;">End Date:</td><td style="text-align: left;">
