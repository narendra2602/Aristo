...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    <html:form action="addUserRights.do?actionRequested=addUserRights">
		...
		%>
            ...
            <table border="0"  cellpadding="0" cellspacing="0" class="tablereg">
		      ...
		      <tr>
				...
				<input type="hidden" name="tp" value="<%=typ%>"/>				</td>
                <td width="14"><html:checkbox property="checkbox2" value="MS01"/> </td>
                <td>Account Master</td>
                <td width="4">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS02"/></td>
                <td>Product Master</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS03"/></td>
                <td>Group Master (Sales)</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS04"/></td>
                <td>Group Master (MKT)</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS05"/></td>
                <td>Area Master</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS06"/></td>
                <td>Region Master</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS07"/></td>
                <td>H.Q. Master</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="MS08"/></td>
		...
		<% 
		if ((typ.equals("Branch")) || (typ.equals("Both")))
		{
		%>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST01"/></td>
                <td>Selective Stockiest Product Wise Credit Note Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST02"/> </td>
                <td>Selective Stockiest Prod Wise Gross/Credit/Net Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST03"/> </td>
                <td>Stockiest Wise Rs.-Wise Trend Gross/Credit/Net</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST04"/> </td>
                <td>Selective Stockiest Wise Product Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST05"/> </td>
                <td>Selective Stockiest Wise Group Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST06"/> </td>
                <td>Stockiest Rupees Wise Salable/Exp/Brk</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST07"/> </td>
                <td>Selective Stockiest Group Wise Credit Note Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="ST08"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BM03"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BM11"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BM14"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IY04"/> </td>
                <td>Near Expiry List</td>
                <td>&nbsp;</td>
              </tr>
			  <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IY05"/> </td>
                <td>Stock Analysis as on</td>
                <td>&nbsp;</td>
              </tr>			  
			  <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="IY06"/> </td>
		...
		if ((typ.equals("HO")) || (typ.equals("Both")))
		{
		%>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HI04"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HI08"/> </td>
                <td>HO-Branch Wise -Rupees Wise Sales Trend</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HI09"/> </td>
                <td>HO-Selective Product HQ Wise</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HI10"/> </td>
                <td>HO-HQ Wise Rupee Value (Net-Trend)</td>
                <td>&nbsp;</td>
              </tr>
			  <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HI11"/> </td>
                <td>HO-Selective Product HQ-Wise Rupee Value (Net-Trend)</td>
                <td>&nbsp;</td>
              </tr>
			  <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HI12"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HM03"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HM05"/> </td>
                <td>HO-Branch Wise-Rupees Wise Net Sales Trend</td>
                <td>&nbsp;</td>
              </tr>
			  <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HM06"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HY01"/> </td>
                <td>HO-Stock and Sales Statement</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HY02"/> </td>
                <td>HO-Item Wise Analysis</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HY03"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HY04"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="HY05"/> </td>
		...
		<% } %>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM01"/> </td>
                <td>Stock & Sales</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM02"/> </td>
                <td>Stock Ledger</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM03"/> </td>
                <td>Near Expiry List</td>
                <td>&nbsp;</td>
              </tr>			  
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM04"/> </td>
                <td>Item Wise Sale</td>
                <td>&nbsp;</td>
              </tr>			  
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM05"/> </td>
                <td>Party Wise/Item Wise</td>
                <td>&nbsp;</td>
              </tr>			  
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM06"/> </td>
                <td>Transfer Register</td>
                <td>&nbsp;</td>
              </tr>			  
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM07"/> </td>
                <td>Sample Register</td>
                <td>&nbsp;</td>
              </tr>			  
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="SM08"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="FT01"/> </td>
                <td>Dispatch Register</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="FT02"/> </td>
                <td>Daily Dispatch Report</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="FT03"/> </td>
                <td>Goods in Transit</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="FT04"/> </td>
                <td>Dispatch Summery</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="FT05"/> </td>
                <td>Product Wise Dispatch</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BL01"/> </td>
                <td>Daily Entry</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BL02"/> </td>
                <td>Daily Report</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BL03"/> </td>
                <td>Budget Entry</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="BL04"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TL03"/> </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TL05"/> </td>
                <td>Sample Updation</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><html:checkbox property="checkbox2" value="TL06"/> </td>
