...
<%@ page import="com.aristo.valueobject.Repo11FormBean" %>  
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br>  
	 ...
	 x = x + " "+y;
      ...
      int z=0;
      int i=0;
            Repo11FormBean rf = new Repo11FormBean();  
           	List l=(List) request.getAttribute("rlist"); 
             	Iterator it =  l.iterator();
             	if(it.hasNext())
             	{
             	 rf=(Repo11FormBean)it.next();    
             	  whead=rf.getHead1();
...
%> 
    ...
    <jsp:scriptlet>
        request.setAttribute("dyndecorator", new org.displaytag.decorator.TableDecorator()
        {
            ...
            {
              int data = ((Repo11FormBean)getCurrentRowObject()).getColor();
			  if (data==2)
			     return "vbad";
			  else
			    if (data==3)
    ...
    <br/>
	<div id="main">	
      <display:table id="data"  name="requestScope.rlist" requestURI="./HQListRepo11.do?actionRequested=HQListRepo11" pagesize="25"  export="true" decorator="dyndecorator">
