...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HQListRepo7.do?actionRequested=HQListRepo7">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                 <th colspan="6">Selective Group - HQ/Region/Area/Branch</th>
              ...
              <% String d = (String) request.getAttribute("data"); %>
				...
				<html:select property="eyear" onchange="showCustomer(this.value,'AjaxRepo7.do?actionRequested=AjaxRepo7')">   
