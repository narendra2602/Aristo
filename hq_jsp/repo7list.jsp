...
%>
    ...
    <br/>
	<div id="main">	
      <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./HQListRepo7.do?actionRequested=HQListRepo7" pagesize="25"  export="true" decorator="totals">
...
<display:column property="mname" title="NAME"  /> 
            ...
            <display:column property="val2" title="SALE VALUE" format="{0,number,0.00}" headerClass="r" class="r"/> 
            <display:column property="val3" title="SALABLE VALUE" format="{0,number,0.00}" headerClass="r" class="r"/> 
            <display:column property="val4" title="E/B/S/PD VALUE" format="{0,number,0.00}" headerClass="r" class="r" />
            <display:column property="val5" title="NET VALUE" format="{0,number,0.00}" headerClass="r" class="r" />
	</display:table> 
</div>	
 <%
   }
