...
<%@ page import="com.aristo.valueobject.Repo9FormBean" %>  
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   String y = lfb.getAccess_t();         
      ...
      for (int j=1; j<=k; j++)  
        {
            Repo9FormBean rf = new Repo9FormBean();  
			e = new Integer(j);
			is = e.toString();
    ...
    <br/> 
	<div id="main">	
      <display:table id="<%=iid%>"  name="sessionScope.list" requestURI="./HQListRepo9.do?actionRequested=HQListRepo9" pagesize="25"  export="true" > 
