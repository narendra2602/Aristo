...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HQListRepo18.do?actionRequested=HQListRepo18">
                 <p>&nbsp;</p>
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                            <th colspan="6">Selective Product - Stockiest Wise Trend  </th>
					...
					<table class="table3" align="center">
   					   <tr>
							 ...
							 <td align="center">Select <%=d%> <br/>
								   ...
								   <html:optionsCollection name="Repo18Form"
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <html:select property="eyear">
                      <html:optionsCollection name="Repo18Form" property="ylist" label="yname" value="yval" />
                    </html:select>		
