...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <br/>
    <div id="main">
   <display:table id="data" name="requestScope.rlist" requestURI="./HQListForm11.do?actionRequested=HQListForm11" pagesize="25" export="true"  decorator="dyndecorator" >
        ...
        <display:caption media=" excel rtf pdf">BRANCH NAME: <%=ak%>, <%=whead%>,  LAST UPDATE: <%=lupdate%></display:caption>
			...
			%>
             ...
             %> 
	            ...
	            <display:column property="qty3" title="<%=trep%>" headerClass="r" class="r" /> 
