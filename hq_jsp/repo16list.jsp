...
<%@ page import="com.aristo.valueobject.Repo16FormBean" %>  
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br>  
      ...
      for (int j=1; j<=k; j++) 
        {
            Repo16FormBean rf = new Repo16FormBean();  
			e = new Integer(j);
			is = e.toString();
    ...
    <br/>
<div id="main">	
      <display:table id="<%=iid%>"  name="sessionScope.list" requestURI="./HQListRepo16.do?actionRequested=HQListRepo16" pagesize="25"  export="true" >
