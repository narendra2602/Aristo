...
%>
    ...
    <br/>
<div id="main">	
  <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./HQListForm10.do?actionRequested=HQListForm10" pagesize="25" export="true" decorator="dyndecorator">
