...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
          ...
          <html:form action="HQListRepo10.do?actionRequested=HQListRepo10">
          <p>&nbsp;</p>
          <table align="center" cellpadding="0" cellspacing="0" class="table2">
                 <th colspan="6">Stockiest/Product Wise Gross Sales Trend </th>
              
               <tr>
                 <td colspan="5"><table class="table3" align="center">
                   <tr>
                     <td><html:radio property="rep_type"  value="1"/>Gross</td>
                     <td><html:radio property="rep_type"  value="2"/>Credit</td>
                     <td><html:radio property="rep_type"  value="3"/>Net&nbsp;&nbsp;</td>
                   </tr>
                   <tr>
    ...
    <html:optionsCollection name="Repo10Form" property="xlist" label="mname" value="mcode" />  
	</html:select>					     </td> 
					     <td>
					<br/>
	...
	<html:optionsCollection name="Repo10Form" property="rlist" label="mname" value="mcode" />  
    </html:select>					  </td>
				   </tr>
			    </table>			  </td>
			</tr> 
                ...
                <tr>
                  <td> Select Month
                    ...
                    <html:select property="eyear">
                      <html:optionsCollection name="Repo10Form" property="ylist" label="yname" value="yval" />
                    </html:select>
                  </td>
                </tr>
              </table></td>
