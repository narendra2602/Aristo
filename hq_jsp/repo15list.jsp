...
<%@ page import="com.aristo.valueobject.Repo15FormBean" %>  
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
      ...
      <br>  
       ...
       for (int j=1; j<=k; j++) 
        {
            Repo15FormBean rf = new Repo15FormBean();  
			e = new Integer(j);
			is = e.toString();
    ...
    <br/>
<div id="main">	
   <display:table id="<%=iid%>"  name="sessionScope.list" requestURI="./HQListRepo15.do?actionRequested=HQListRepo15" pagesize="25"  export="true" >
