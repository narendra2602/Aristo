...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   ...
   <html:form action="HQListRepo14.do?actionRequested=HQListRepo14">
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table border="0" align="center" cellpadding="0" cellspacing="0" class="usertable">
                  <th colspan="7">Stockiest Wise Rupees Wise Expiry Breakage</th>
              ...
              <tr>
				...
				<html:select property="eyear">
		                <html:optionsCollection name="Repo14Form" property="ylist" label="yname" value="yval" />
        		</html:select>	
