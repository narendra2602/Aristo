...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
		 <div id="main">
               <html:form action="HQListForm4.do?actionRequested=HQListForm4">
                 <p>&nbsp;</p>
			
                 <table align="center" cellpadding="0" cellspacing="0" class="table2">
                    <th colspan="6"> Selective HQ/Region/Area/Branch/Product Wise Detail</th>

                 <tr>
                  <td colspan="5">
				  <table class="table3" align="center">
                    <tr>
                      <td><html:radio property="uv"  value="1"/>Product Unit Wise</td>
                      <td><html:radio property="uv"  value="2"/>Product Value Wise</td>
                      <td><html:radio property="uv"  value="3"/>Sales Review</td>
                    </tr>
					<tr>
						  <td><html:radio property="sl"  value="1"/>Selective HQ</td>
						  <td><html:radio property="sl"  value="2"/>All HQ</td>
					</tr>
					<tr>
						  <td><html:radio property="rep_type"  value="1"/>SP-1</td>
						  <td><html:radio property="rep_type"  value="2"/>BP-1</td>
						  <td><html:radio property="rep_type"  value="3"/>BP-2</td>
					</tr>
