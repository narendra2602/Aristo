...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
          ...
          <html:form action="HQListRepo16.do?actionRequested=HQListRepo16">
          <p>&nbsp;</p>
          <table align="center" cellpadding="0" cellspacing="0" class="table2">
                 <th colspan="6">Stockiest/Group Wise Gross Sales Trend </th>
    ...
    <html:optionsCollection name="Repo16Form" property="xlist" label="mname" value="mcode" />  
	</html:select>					     </td> 
					     <td>
					<br/>
	...
	<html:optionsCollection name="Repo16Form" property="rlist" label="mname" value="mcode" />  
    </html:select>					  </td>
				   </tr>
			    </table>			  </td>
			</tr> 
				...
				<table class="table3" align="center">
				  <tr>
                    ...
                    <html:select property="eyear">
                      <html:optionsCollection name="Repo16Form" property="ylist" label="yname" value="yval" />
                    </html:select>					
