...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
          ...
          <html:form action="HQListRepo15.do?actionRequested=HQListRepo15">
          <p>&nbsp;</p>
          <table align="center" cellpadding="0" cellspacing="0" class="table2">
                 <th colspan="6">Stockiest Group Wise Credit Note Trend</th>
              <tr>
                <td colspan="5">
				   <table align="center" class="table3">
						<tr>
					        <td> <html:radio property="rep_type"  value="1"/>Expiry</td>
							<td> <html:radio property="rep_type"  value="2"/>Breakage</td>
							<td> <html:radio property="rep_type"  value="3"/>Salable</td>
							<td> <html:radio property="rep_type"  value="4"/>Spoiled</td>
						    <td> <html:radio property="rep_type"  value="5"/>PD</td>
							<td> <html:radio property="rep_type"  value="6"/>All</td>
						</tr>
			      </table>				</td>
              </tr>
	...
	<html:select style="width:300px" property="codes" multiple="true" size="7" styleId="available" onchange="doUpdate( false,true );">
    <html:optionsCollection name="Repo15Form" property="xlist" label="mname" value="mcode" />  
	</html:select>					     </td> 
					     <td>
					<br/>
		<input type="button" style="width:50px;" id="add" onClick="doMove( 'available', 'chosen', false );" value=">>" />
		<input type="button" style="width:50px;" id="addAll" onClick="doMove( 'available', 'chosen', true );" value=">>>" />
					<br />
					<br />
 	    <input type="button" style="width:50px;" id="remove" onClick="doMove( 'chosen', 'available', false );" value="<<" />
		<input type="button" style="width:50px;" id="removeAll" onClick="doMove( 'chosen', 'available', true );" value="<<<" />
				
	<html:hidden styleId="chosenItem" property="chosenItem" />					   </td> 
					   <td>Selected <%=d%>
								  <br/>
	<html:select style="width:300px" property="codes1" multiple="true" size="7" styleId="chosen" onchange="doUpdate( true, false );">
	<html:optionsCollection name="Repo15Form" property="rlist" label="mname" value="mcode" />  
    </html:select>					  </td>
				   </tr>
			    </table>			  </td>
			</tr> 
				...
				<table class="table3" align="center">
				  <tr>
                    ...
                    <html:select property="eyear">
                      <html:optionsCollection name="Repo15Form" property="ylist" label="yname" value="yval" />
                    </html:select>					
