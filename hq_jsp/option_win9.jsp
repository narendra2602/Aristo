...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
          ...
          <html:form action="HQListRepo9.do?actionRequested=HQListRepo9">
          <p>&nbsp;</p>
          <table align="center" cellpadding="0" cellspacing="0" class="table2">
               <th colspan="6">Stockiest Wise Trend Expiry/Breakage/Salable </th>
              <tr>
                <td colspan="5">
				   <table align="center" class="table3">
						<tr>
						  ...
						  <td> <html:radio property="rep_type"  value="5"/>
							PD</td>
    ...
    <html:optionsCollection name="Repo9Form" property="xlist" label="mname" value="mcode" />  
	</html:select>
					     </td> 
					     <td>
					<br/>
	...
	<html:optionsCollection name="Repo9Form" property="rlist" label="mname" value="mcode" />  
    </html:select>
					  </td>
				   </tr>
			    </table>	
                ...
                <tr>
                  <td> Select Month
                    ...
                    <html:select property="eyear">
                      <html:optionsCollection name="Repo9Form" property="ylist" label="yname" value="yval" />
                    </html:select>
                  </td>
                </tr>
              </table></td>
