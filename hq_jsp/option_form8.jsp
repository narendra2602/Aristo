...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
               ...
               <html:form action="HQListForm8.do?actionRequested=HQListForm8">
                 <p>&nbsp;</p>
                 <table border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
                   <th colspan="2">Selective Products- Sales/Taget Trend</th>
                  ...
                  <tr>
		                <td>
						   <table border="0" align="center" cellpadding="0" cellspacing="0" class="table3">
                             ...
                             <tr>
                               <td>&nbsp;<html:radio property="pg"  value="1"/>Sales</td>
                               <td><html:radio property="pg"  value="2"/>Target</td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
                             </tr>
                           </table>
