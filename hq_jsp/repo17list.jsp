...
<%@ page import="com.aristo.valueobject.Repo17FormBean" %>  
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
    ...
    <br>   
      ...
      for (int j=1; j<=k; j++) 
        {
            Repo17FormBean rf = new Repo17FormBean();  
        	List l = (List) map.get(j);  
             	Iterator it =  l.iterator();
             	if(it.hasNext())
             	{
             	 rf=(Repo17FormBean)it.next();    
             	  whead=rf.getHead1();
                }  
    ...
    <br/>
<div id="main">	
   <display:table id="<%=iid%>" class="simple nocol" name="sessionScope.list" requestURI="./HQListRepo17.do?actionRequested=HQListRepo17" pagesize="25"  export="true" decorator="totals">
