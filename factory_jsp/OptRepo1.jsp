...
<body >
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="FactoryListRepo1.do?actionRequested=FactoryListRepo1" onsubmit="return validateDate()">
  <center>
  <table cellpadding="0" cellspacing="0" class="table_opt">
    <tr>
      <th colspan="4">Transfer Register</th>
    </tr>
	...
	<tr>
      ...
      <td>Pharma/Lab</td>
      <td>
      <html:radio property="pchoice" value="P" onclick="showCustomer(this.value,'FactoryAjxRepo1.do?actionRequested=FactoryAjxRepo1')" /> Pharma &nbsp; &nbsp; &nbsp; &nbsp; 
	  <html:radio property="pchoice" value="L" onclick="showCustomer(this.value,'FactoryAjxRepo1.do?actionRequested=FactoryAjxRepo1')" /> Lab
	  </td>	  
    </tr>
   ...
   <div id="abc">	  
     <html:select property="loc" style="width:190px" >
	        <html:optionsCollection name="FacRepo1Form" property="loclist" label="lcname" value="lcval" />   
	  </html:select>
   </div>	  
	  </td>
    </tr>
    ...
    <tr>
      ...
      <html:select property="sbranch" style="width:190px" styleId="mySelect" >
	        <html:optionsCollection name="FacRepo1Form" property="brlist" label="brname" value="brval" />   
	  </html:select>	
