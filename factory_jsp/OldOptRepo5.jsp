...
<html:form action="FactoryListRepo5.do?actionRequested=FactoryListRepo5" onsubmit="return validateDate()">
  ...
  <table cellpadding="0" cellspacing="0" class="table_opt">
	...
	<tr>
      ...
      <td>Pharma/Lab</td>
      <td>
      <html:radio property="pchoice" value="P"  onclick="showCustomer(this.value,'FactoryAjxRepo5.do?actionRequested=FactoryAjxRepo5')" /> Pharma &nbsp; &nbsp; &nbsp; &nbsp; 
	  <html:radio property="pchoice" value="L" onclick="showCustomer(this.value,'FactoryAjxRepo5.do?actionRequested=FactoryAjxRepo5')" /> Lab
	  </td>	  
    </tr>
