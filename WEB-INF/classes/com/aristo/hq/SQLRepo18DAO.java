...
public class SQLRepo18DAO {
	...
	public List getAllHQ(Connection con, int code,int uv,int rtype,int emon,int eyear,int depo_code,String tp,int uid) { 
...
//		 	" order by a.mterr_code,a.mac_name";
	  	 	...
	  	 	" s.valoct,s.valnov,s.valdec,s.valjan,s.valfeb,s.valmar,"+
	  	 	" s.valapr,s.valmay,s.valjun,s.valjul,s.valaug,s.valsep "+
	  	 	" from "+tblnm2+" a, "+tblnm3+" h,"+tblnm+" s,user_ter u "+ 
	  	 	...
	  	 	" and a.depo_code=h.depo_code and a.depo_code=s.depo_code and s.depo_code=h.depo_code "+
	  	 	" and u.ter_code=a.mterr_code and u.ter_code=h.ter_code and u.ter_code=s.tr_cd "+
	  	 	" and h.ter_code=s.tr_cd and a.mterr_code=h.ter_code and a.mterr_code=s.tr_cd "+
	  	 	" and s.pr_code="+code+" and a.mac_code=s.stk_code and u.user_id="+uid+" and u.status=? "+  
	  	 	" order by a.depo_code,a.mterr_code,a.mac_name " ;	  	 	
 		 }
...
// 		 	" group by s.stk_code order by a.mterr_code,a.mac_name";
 		 	...
 		 	" from "+tblnm2+" a, "+tblnm3+" h,"+tblnm+" s,user_ter u "+ 
	  	 	...
	  	 	" and h.ter_code=s.tr_cd and a.mterr_code=h.ter_code and a.mterr_code=s.tr_cd "+
	  	 	" and s.pr_code="+code+" and a.mac_code=s.stk_code and u.user_id="+uid+" and u.status=? "+  
	  	 	" group by s.stk_code order by a.depo_code,a.mterr_code,a.mac_name " ;	  	 	
