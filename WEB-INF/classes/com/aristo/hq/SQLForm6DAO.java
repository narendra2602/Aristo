...
//////////////////////// Target master ki query///////////////////////////////
	 		String query3=null;
            query3 = "Select sum((((tt"+mon+"*ttarget)/100)*tmrp)),sum(((tt"+mon+"*ttarget)/100)),tmrp,budmnth,budper,budtar,budval from "+tblnm+" where tr_cd=? "+
	        ...
	        if(rst3.next())/////////////////Target Master Start///////////////////
		        {
			    	...
			    	if (mrec.getInt(6)>=rst3.getInt(4))
			    	 {
			    		montar = montar+((rst3.getDouble(6)*rst3.getDouble(5))/100);
			    		ggmontar = ggmontar+((rst3.getDouble(7)*rst3.getDouble(5))/100);				    		
			    	 }
		         }	 /////////////////////Target Master End//////////////////////
...
///////////////////////////// All Statment Close/////////////////////////////
			...
			System.out.println("========Exception in HQ-SQLForm6DAO.getForm6 " + e); 
		}
		  finally 
			{
			  try
				...
				{
				  System.out.println("-------------Exception in HQ-SQLForm6DAO.Connection.close "+e);
				}
			}
		return data;
	}
