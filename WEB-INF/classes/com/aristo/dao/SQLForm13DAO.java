...
///////////////////////////////Headquater Coding Start Here//////////////////////////////////
	...
	public List getAllHQ(Connection con, int uv,int code, int smon,int emon,int eyear,int depo_code,String tp) { 
...
//        	tblnm=tp+"_target08";
            ...
            tblnm3=(tp+"_product08").toLowerCase();
...
//////////////////////////////////Grand Total ke Liye//////////////////////////////////
		      ...
		      {
			  System.out.println("===Exception in SQLForm13DAO.getAllHQ " + e); 
		      }
		  ...
		  finally 
			{
				...
				{
					System.out.println("-------------Exception in SQLForm13DAO.Connection.close "+e);
				}
			}
		return data;
	}
...
///////////////////////////////Region Coding Start Here//////////////////////////////////
	...
	public List getAllRegion(Connection con, int uv,int code, int smon,int emon,int eyear,int depo_code,String tp) { 
...
//        	tblnm=tp+"_target08";
            ...
            tblnm4=(tp+"_region_master08").toLowerCase();
			 ...
			 if (uv==1)
	             txt2="     REGION WISE UNIT WISE SALES ANALYSIS FROM "; 
			 if (uv==2)
	             txt2="     REGION WISE VALUE WISE SALES ANALYSIS FROM "; 
			 if (uv==3)
	             txt2="     REGION WISE UNIT/VALUE WISE SALES ANALYSIS FROM "; 
...
//		 	query3 = "Select sum(((tt"+mon+"*tvalue)/100)), sum(ra"+mon+"),sum(rl"+mon+"),sum(((tt"+mon+"*ttarget)/100)), sum(ta"+mon+"),sum(la"+mon+"),max(budmnth),sum((budtar*budper)/100),sum((budval*budper)/100) from "+tblnm+" where rg_cd=? "+
//            " and depo_code=? and pr_code=? and mkt_year=? group by rg_cd order by ar_cd,rg_cd,tr_cd,pr_code";
		 	
		 	 query3 = "Select sum(tt"+mon+"),sum(ra"+mon+"),sum(rl"+mon+"),sum(tq"+mon+"),sum(ta"+mon+"),sum(la"+mon+"),0 as budmnth,0 as budper,0 as budval from "+tblnm+" where rg_cd=? "+
             " and depo_code=? and mcode=? and mkt_year=? group by rg_cd order by ar_cd,rg_cd,tr_cd,mcode"; 
...
///////////////////////////////Area Coding Start Here//////////////////////////////////
	...
	public List getAllArea(Connection con, int uv,int code, int smon,int emon,int eyear,int depo_code,String tp) { 
...
//        	tblnm=tp+"_target08";
            ...
            tblnm4=(tp+"_area_master08").toLowerCase();
			 ...
			 if (uv==1)
	             txt2="     AREA WISE UNIT WISE SALES ANALYSIS FROM "; 
			 if (uv==2)
	             txt2="     AREA WISE VALUE WISE SALES ANALYSIS FROM "; 
			 if (uv==3)
	             txt2="     AREA WISE UNIT/VALUE WISE SALES ANALYSIS FROM "; 
...
////////////////////////Area  Master Query/////////////////////////////////            
		...
		rst1 = ps1.executeQuery();
			...
			while (rst1.next())   ////////////////Area Loop Start/////////////////
			{
				rfb = new MktFormBean();
                rfb.setMcode(index);
                rfb.setQty3(uv);
...
//		 	query3 = "Select sum(((tt"+mon+"*tvalue)/100)), sum(ra"+mon+"),sum(rl"+mon+"),sum(((tt"+mon+"*ttarget)/100)), sum(ta"+mon+"),sum(la"+mon+"),max(budmnth),sum((budtar*budper)/100),sum((budval*budper)/100) from "+tblnm+" where ar_cd=? "+
//            " and depo_code=? and pr_code=? and mkt_year=?  group by ar_cd order by ar_cd,rg_cd,tr_cd,pr_code";
		 	
		 	 query3 = "Select sum(tt"+mon+"),sum(ra"+mon+"),sum(rl"+mon+"),sum(tq"+mon+"),sum(ta"+mon+"),sum(la"+mon+"),0 as budmnth,0 as budper,0 as budval from "+tblnm+" where ar_cd=? "+
             " and depo_code=? and mcode=? and mkt_year=? group by ar_cd order by ar_cd,rg_cd,tr_cd,mcode"; 
...
///////////////////////////////Branch Coding Start Here//////////////////////////////////
	...
	public List getAllBranch(Connection con, int uv,int code, int smon,int emon,int eyear,int depo_code,String tp) { 
...
//            tblnm=tp+"_target08";
            ...
            tblnm4=(tp+"_branch08").toLowerCase();
			 ...
			 if (uv==1)
	             txt2="     BRANCH WISE UNIT WISE SALES ANALYSIS FROM "; 
			 if (uv==2)
	             txt2="     BRANCH WISE VALUE WISE SALES ANALYSIS FROM "; 
			 if (uv==3)
	             txt2="     BRANCH WISE UNIT/VALUE WISE SALES ANALYSIS FROM "; 
...
//		 	query3 = "Select sum(((tt"+mon+"*tvalue)/100)), sum(ra"+mon+"),sum(rl"+mon+"),sum(((tt"+mon+"*ttarget)/100)), sum(ta"+mon+"),sum(la"+mon+"),max(budmnth),sum((budtar*budper)/100),sum((budval*budper)/100) from "+tblnm+" where  "+
//            " depo_code=? and pr_code=? and mkt_year=? group by depo_code order by depo_code,ar_cd,rg_cd,tr_cd,pr_code";
		 	
		 	 query3 = "Select sum(tt"+mon+"),sum(ra"+mon+"),sum(rl"+mon+"),sum(tq"+mon+"),sum(ta"+mon+"),sum(la"+mon+"),0 as budmnth,0 as budper,0 as budval from "+tblnm+" where  "+
             "  depo_code=? and mcode=? and mkt_year=? group by depo_code order by depo_code,ar_cd,rg_cd,tr_cd,mcode"; 
...
//////////////////////////////////Grand Total ke Liye//////////////////////////////////
		      ...
		      {
			  System.out.println("===Exception in SQLForm13DAO.getAllBranch " + e); 
		      }
