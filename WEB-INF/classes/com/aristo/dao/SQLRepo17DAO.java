...
//////////////////////////////////////////////////////////////////////////////////////////
            ...
            String query1 = "Select mac_code,mac_name,mcity from "+tblnm2+" where depo_code=? and mterr_code<>? and mkt_year=? order by mac_name";
			...
			System.out.println("========Exception in SQLRepo17DAO.getAllStockiest17 " + e); 
		}
		finally {
			try 
			{
	           ...
	           if(con != null){con.close();}
				...
				System.out.println("-------------Exception in SQLRepo17DAO.Connection.close "+e);
			  }
		}
