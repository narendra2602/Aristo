...
//////////////////////////////////////Group Master Query///////////////////////////////////////////            
    	...
    	query3 ="Select sum("+unm+"),sum("+vnm+"),sum(e"+unm+"),sum(e"+vnm+"),sum(b"+unm+"),sum(b"+vnm+"),sum(r"+unm+"),sum(r"+vnm+")," +
        ...
        rst3 = ps3.executeQuery();
			        ...
			        if(rst3.next())
			        {
		 			  ...
		 			  if (rep==2)
		 			  {
                            rfb.setVal1(k, (rst3.getDouble(4)+rst3.getDouble(6)+rst3.getDouble(8)+rst3.getDouble(10)+rst3.getDouble(12)));
                            hval=hval+(rst3.getDouble(4)+rst3.getDouble(6)+rst3.getDouble(8)+rst3.getDouble(10)+rst3.getDouble(12));
                            vval[k]=vval[k]+(rst3.getDouble(4)+rst3.getDouble(6)+rst3.getDouble(8)+rst3.getDouble(10)+rst3.getDouble(12));
		 			  }
		 			  if (rep==3)
		 			  {
                            rfb.setVal1(k, (rst3.getDouble(2)- (rst3.getDouble(4)+rst3.getDouble(6)+rst3.getDouble(8)+rst3.getDouble(10)+rst3.getDouble(12))));
                            hval=hval+(rst3.getDouble(2)- (rst3.getDouble(4)+rst3.getDouble(6)+rst3.getDouble(8)+rst3.getDouble(10)+rst3.getDouble(12)));
                            vval[k]=vval[k]+(rst3.getDouble(2)- (rst3.getDouble(4)+rst3.getDouble(6)+rst3.getDouble(8)+rst3.getDouble(10)+rst3.getDouble(12)));
		 			  }
			...
			System.out.println("========Exception in SQLRepo16DAO.getAllStockiest16 " + e); 
		}
		...
		try {
			  ...
			  {
				System.out.println("--Exception in SQLRepo16DAO.Connection.close "+e);
			  }
		}
