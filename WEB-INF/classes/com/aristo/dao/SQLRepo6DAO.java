...
public class SQLRepo6DAO {
	...
	public List getAllrepo(Connection con, int code,int smon,int emon,int eyear,int depo_code,String tp) { 
...
//////////////////////////////////////////////////////////////////////////////////////////
		    ...
		    "  and pr_code=? and depo_code=? and mkt_year=? group by tr_cd order by ar_cd,rg_cd,tr_cd"; 
			...
			System.out.println("========Exception in SQLRepo6DAO.getAllHQrepo6 " + e); 
		}
		finally 
		{
		try {
...
///////////////////////////////////////Region Coding Start Here/////////////////////////////////
	public List getAllRegion(Connection con, int code,int smon,int emon,int eyear,int depo_code,String tp) { 
...
//////////////////////////////////////////////////////////////////////////////////////////
			...
			System.out.println("========Exception in SQLRepo6DAO.getAllRegion " + e); 
		}
		finally 
		{
		try {
...
///////////////////////////////////////Area Coding Start Here/////////////////////////////////	
	public List getAllArea(Connection con, int code,int smon,int emon,int eyear,int depo_code,String tp) { 
...
//////////////////////////////////////////////////////////////////////////////////////////            
			...
			System.out.println("========Exception in SQLRepo6DAO.getAllArea " + e); 
		}
		finally 
		{
		try {
...
///////////////////////////////////////Branch Coding Start Here/////////////////////////////////
	public List getAllBranch(Connection con, int code,int smon,int emon,int eyear,int depo_code,String tp) { 
...
//////////////////////////////////////////////////////////////////////////////////////////            
			...
			System.out.println("========Exception in SQLRepo6DAO.getAllBranch " + e); 
		}
		finally 
		{
		try {
