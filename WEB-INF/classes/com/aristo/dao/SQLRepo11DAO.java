...
public class SQLRepo11DAO {
	...
	public List getAllStk(Connection con,int smon,int emon,int st,int eyear,int depo_code,String tp) { 
		...
		try {     
        	...
        	tblnm1=(tp+"_hq_master08").toLowerCase();
...
//////////////////////////////Main query for Headquater/Account/Stockiest /////////////////////////////////
      if (st==1)
      {
	 	...
	 	" AND a.DEPO_CODE = ? 	and h.mkt_year = ? and h.depo_code = ?  " +
	 	" and s.mkt_year = ? and s.depo_code = ? and 	a.mac_code = s.stk_code " +
	 	" and h.ter_code = s.tr_cd  " +
	 	" group by s.tr_cd,s.stk_code order by a.mterr_code,a.mac_name";
      }
...
//////////////////////////////Headquater ki Query/////////////////////////////////
        //String query2 = "Select ter_code,ter_name from "+tblnm1+" where depo_code=? and ter_pt=? and mkt_year=? order by area_code,regn_code,ter_code";
        ...
        rst2 = ps2.executeQuery();
			...
			System.out.println("========Exception in SQLRepo11DAO.getAllSktRepo11 " + e); 
		}
			...
			try {
				...
				System.out.println("-------------Exception in SQLRepo11DAO.Connection.close "+e);
			  }
		}		
