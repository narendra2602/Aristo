...
public class SQLForm1DAO {

	public List getAllHQ(Connection con, int code, int emon,int eyear,int depo_code,String tp) { 
...
////////////////////////////Headquater Master Ki Query//////////////////////////////////
			...
			" and depo_CODE =? "+
			" group by ar_cd,area_name,rg_cd,reg_name,tr_cd,ter_name,mcode) as a "+
			" left join "+
			" (select ar_cd,area_name,rg_cd,reg_name,tr_cd,ter_name,mcode,sum(lysval) clysval,sum(tarval) ctarval,sum(salval) csalval  "+
			" from "+tblnm+" where mkt_year = ? and  mnth_code <= ?  and mcode = ? "+
			" and depo_CODE =? "+
			" group by ar_cd,area_name,rg_cd,reg_name,tr_cd,ter_name,mcode) as b "+
...
///////////////////////////////////////////////////
		  ...
		  catch (Exception e) 
		{
			...
			System.out.println("========Exception in SQLForm1DAO.getAllHQForm1 " + e); 
		}
		  finally 
		{
			try
