...
public class SQLRepo13DAO {
	...
	public List getAllStk(Connection con, String code,int smon,int emon,int eyear,int depo_code,String tp) { 
		...
		try {     
            ...
            txt2=" GROUP WISE SALES DETAIL FROM ";
...
/////////////////////////////////////////////Account Master//////////////////////////////////////////                
    		...
    		ts1.close();
////////////////////////////////////////////////Group Master////////////////////////////////////            
            String query1 = "Select distinct(gp_code),gp_name from "+tblnm1+" where gp_code<>? and mkt_year=? group by gp_code order by gp_code";
		 ...
		 " and mgrp_cd=?  and depo_code=? and mkt_year=? group by stk_code order by ar_cd,rg_cd,tr_cd,mgrp_cd,stk_code"; 
			...
			System.out.println("========Exception in SQLRepo13DAO.getAllStockiest " + e); 
		}
			...
			try 
			{
				...
				System.out.println("-------------Exception in SQLRepo13DAO.Connection.close "+e);
		    }
		}		
		return data;
	}
