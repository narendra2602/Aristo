...
public class SQLInventoryRepo3DAO {
	public List getRepo3(Connection con, String typ, Date sdate ) { 
		...
		try { 
    		...
    		long diffInDays;
           	...
           	String query=" select b.bat_pcode,p.pname,p.pack,b.bat_no,b.bat_netrt,b.bat_recdt,b.bat_clos,b.bat_clos*b.bat_netrt " +
           			     " from "+tblnm1.toLowerCase()+" as p inner join "+tblnm2.toLowerCase()+" as b on p.pcode=b.bat_pcode " +
           			     " where TO_DAYS('"+sdt+"') - TO_DAYS(b.bat_recdt) > 365 and b.bat_clos<>0 order by b.bat_pcode,b.expiry"; 
...
//		         if (diffInDays>90)
			...
			System.out.println("========Exception in SQLInventoryRepo3DAO.getRepo3 " + e);
		}
			...
			try {
				...
				System.out.println("-------------Exception in SQLInventoryRepo3DAO.Connection.close "+e);
			  }
		}		
