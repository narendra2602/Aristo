...
<body>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralInventoryRepo8.do?actionRequested=CentralInventoryRepo8" onsubmit="return validateDate()">
  
  <table cellpadding="0" cellspacing="0" class="upload">
    <tr>
      <th colspan="4">Inward Register Branch Wise</th>
    </tr>
