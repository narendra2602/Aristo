...
<body >
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralListRepo1.do?actionRequested=CentralListRepo1" onsubmit="return validateDate()">
    ...
    <tr>
      ...
      <td>
       <html:select property="sbranch" style="width:147px" styleId="mySelect" >
	        <html:optionsCollection name="CentralRepo1Form" property="brlist" label="brname" value="brval" />   
	  </html:select>	  
