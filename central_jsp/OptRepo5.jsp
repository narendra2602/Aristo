...
<body>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralListRepo5.do?actionRequested=CentralListRepo5" onsubmit="return validateDate()" >
  
  <table cellpadding="0" cellspacing="0" class="upload">
    <tr>
      <th colspan="4">Disptach Summery</th>
    </tr>
    ...
    <tr>
      ...
      <td>
       <html:select property="sbranch" style="width:147px" styleId="mySelect" >
	        <html:optionsCollection name="CentralRepo5Form" property="brlist" label="brname" value="brval" />   
	  </html:select>	  
