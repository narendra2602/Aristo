...
%> 
    ...
    <p>&nbsp;  </p>
	<div class="div1">	  
 <display:table id="data" name="requestScope.InventoryRepo9Form.rlist" requestURI="./CentralInventoryRepo9.do?actionRequested=CentralInventoryRepo9" pagesize="20" export="true" >
