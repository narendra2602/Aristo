...
<body>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralListRepo3.do?actionRequested=CentralListRepo3" onsubmit="return validateDate()">
    ...
    <tr>
      ...
      <td>
       <html:select property="sbranch" style="width:147px" styleId="mySelect" >
	        <html:optionsCollection name="CentralRepo3Form" property="brlist" label="brname" value="brval" />   
	  </html:select>	  
