...
<body>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralInventoryRepo1.do?actionRequested=CentralInventoryRepo1" onsubmit="return validateDate()">
  
  <table cellpadding="0" cellspacing="0" class="upload">
    <tr>
      <th colspan="4">Product Stock Card Summery</th>
    </tr>
