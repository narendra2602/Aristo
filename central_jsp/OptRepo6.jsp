...
<body>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralListRepo6.do?actionRequested=CentralListRepo6" onsubmit="return validateDate()">
  
  <table cellpadding="0" cellspacing="0" class="upload">
    <tr>
      <th colspan="4">Product Wise Dispatch </th>
    </tr>
  ...
  <html:radio property="choice" value="2" onclick="makeDisable()"  />
      ...
      <tr>
        ...
        <td><html:select property="code" styleId="mySelect">
	        <html:optionsCollection name="CentralRepo6Form" property="plist" label="pname" value="pval" />   
	  </html:select></td>
      </tr>
      <tr>
      <td width="10">&nbsp;</td>
