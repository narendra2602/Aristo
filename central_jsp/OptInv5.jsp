...
<body>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<html:form action="CentralInventoryRepo5.do?actionRequested=CentralInventoryRepo5" onsubmit="return validateDate()">
  
  <table cellpadding="0" cellspacing="0" class="upload">
    <tr>
      <th colspan="4">Stock Ledger</th>
    </tr>
	...
	<tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>Selection:</td>
        <td><html:radio property="choice" value="1" onclick="makeEnable()" />
          Selective  &nbsp;  &nbsp; &nbsp;
  <html:radio property="choice" value="2" onclick="makeDisable()"  />
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>Product</td>
        <td><html:select property="code" styleId="mySelect">
	        <html:optionsCollection name="InventoryRepo5Form" property="plist" label="pname" value="pval" />   
	  </html:select></td>
      </tr>
      <tr>
      <td width="10">&nbsp;</td>
